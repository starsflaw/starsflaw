        ...
        <div class="container">
                ...
                <div class="group col-sm-0">
                    ...
                    <table class="table" style="background-color: rgba(45,54,69)">
                        ...
                        <tr>
                            ...
                            <th scope="col"><a href="modify-name" style="color: rgba(55,150,255); font-weight: normal">Modify</a></th>
                        </tr>
                        <tr>
                            <th scope="col" style="color: white;">Email</th>
                            <th scope="col" style="color: white; font-weight: normal"><?php echo $data_profil['email'];?></th>
                            <th scope="col"><a href="modify-email" style="color: rgba(55,150,255); font-weight: normal">Modify</a></th>
                        </tr>
                        <tr>
                            <th scope="col" style="color: white;">Password</th>
                            <th scope="col" style="color: white; font-weight: normal">##########################</th>
                            <th scope="col"><a href="modify-password" style="color: rgba(55,150,255); font-weight: normal">Modify</a></th>
                        </tr>
                        <tr>
            ...
            <div class="form-row justify-content-center">
                <div class="form-group col-sm-0">
                    <a class="btn btn-danger" href="delete.php" role="button">Delete my account</a>
                </div>
            </div>
        </div>
    </body>
