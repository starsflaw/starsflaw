        ...
        <div class="centrer" style="box-shadow: 0 5px 5px rgba(0, 0, 0, .2);">  
            <div class="breadcrumb">
                <nav aria-label="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Modify Username</li>
                    </ol>
                </nav>
            </div> 
        ...
        <div class="container">
            <div class="form-row justify-content-center">
                <div class="form-group col-sm-5">
                    <label for="staticEmail" style="color:rgba(55,150,255)">Current username</label>
                    <p style="color: white"><?php echo $data2['nickname']; ?></p>
                </div>
            </div>
            <div class="form-row justify-content-center">
                <div class="form-group col-sm-5">
                    <label for="nickname" style="color:rgba(55,150,255)">New username</label>
