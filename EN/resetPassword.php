                    ...
                    <div class="container">
                        <div class="form-row justify-content-center">
                            <div class="form-group col-sm-4">
                                <label for="password" style="color:rgba(55,150,255)">Your new password</label>
                        ...
                        <div class="form-row justify-content-center">
                            <div class="form-group col-sm-4">
                                <button type="submit" class="btn btn-primary" id="register" name="register">Confirm</button>
                            </div>
                        </div>
                    </div>
                    <?php
                    ...
                    if(isset($_POST['register']))
                    {
                        ...
                        if(empty($password2))
                        {
                            ...
                            <div class="container">
                                <div class="row justify-content-center">
                                    <div class="group col-sm-1.5">
                                        <strong style="color: red;"> Please confirm your password !</strong>
                                    </div>
                                </div>
                            </div>
                            <?php
