            ...
            <div class="breadcrumb">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Modify my e-mail</li>
                    </ol>
                </nav>
            </div> 
            <h1>Modify my e-mail</h1>
            </br>
            </br>
        </div>
        </br>
            ...
            <div class="container">
                <div class="form-row justify-content-center">
                    <div class="form-group col-sm-5">
                        <label for="staticEmail" style="color:rgba(55,150,255)">Current e-mail</label>
                        <p style="color: white"><?php echo $data2['email']; ?></p>
                    </div>
                </div>
                <div class="form-row justify-content-center">
                    <div class="form-group col-sm-5">
                        <label for="email" style="color:rgba(55,150,255)">New e-mail</label>
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="group col-sm-0">
                                <strong style="color: rgba(0,176,0);"> A confirmation email has been sent to your new address </strong>
                            </div>
                        </div>
                    </div>
                    <?php
