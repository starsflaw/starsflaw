        ...
        <div class="container-fluid">
            ...
            <div class="row justify-content-center">
                <div class="group col-sm-0" style="color:white; font-size: 14px">
                    <a style="color:white; font-size: 14px" href="../confidentiality">Confidentialité </a>
                    |
                    <a style="color:white; font-size: 14px" href="../legal-notice"> Mentions légales </a>
                    |
                    <a style="color:white; font-size: 14px" href="../terms-of-service"> Conditions Générales d'Utilisation </a>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="group col-sm-0" style="color:white; font-size: 14px">
